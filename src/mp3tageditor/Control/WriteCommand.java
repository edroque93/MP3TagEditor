...
public class WriteCommand extends Command {
    ...
    public void execute() {
        ...
        id3v1.setSignature(new ByteHolder("ID3v1", ID3v1.ID3v1_SIGNATURE_SIZE, false));
    ...
    private void fillID3Structure(ID3v1 id3v1) {
        id3v1.setTitle(new ByteHolder(tagEditorPanel.getTitle().getText(), ID3v1.ID3v1_TITLE_SIZE, false));
        id3v1.setArtist(new ByteHolder(tagEditorPanel.getArtist().getText(), ID3v1.ID3v1_ARTIST_SIZE, false));
        id3v1.setAlbum(new ByteHolder(tagEditorPanel.getAlbum().getText(), ID3v1.ID3v1_ALBUM_SIZE, false));
        id3v1.setYear(new ByteHolder(tagEditorPanel.getYear().getText(), ID3v1.ID3v1_YEAR_SIZE, false));
        id3v1.setComment(new ByteHolder(tagEditorPanel.getComment().getText(), ID3v1.ID3v1_COMMENT_SIZE, false));
